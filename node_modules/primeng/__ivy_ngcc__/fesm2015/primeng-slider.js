...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r1064.handleValues[0] + "%", ctx_r1064.handleValues[1] - ctx_r1064.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r1065.handleValues[0] + "%", ctx_r1065.handleValues[1] - ctx_r1065.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r1066.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r1067.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1073); const ctx_r1072 = ɵngcc0.ɵɵnextContext(); return ctx_r1072.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1073); const ctx_r1074 = ɵngcc0.ɵɵnextContext(); return ctx_r1074.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1073); const ctx_r1075 = ɵngcc0.ɵɵnextContext(); return ctx_r1075.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1073); const ctx_r1076 = ɵngcc0.ɵɵnextContext(); return ctx_r1076.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1073); const ctx_r1077 = ɵngcc0.ɵɵnextContext(); return ctx_r1077.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1068 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r1068.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r1068.orientation == "horizontal" ? ctx_r1068.handleValue + "%" : null, ctx_r1068.orientation == "vertical" ? ctx_r1068.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r1068.tabindex)("aria-valuemin", ctx_r1068.min)("aria-valuenow", ctx_r1068.value)("aria-valuemax", ctx_r1068.max)("aria-labelledby", ctx_r1068.ariaLabelledBy);
} }
const _c8 = function (a0) { return { "ui-slider-handle-active": a0 }; };
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    const _r1080 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 10);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1080); const ctx_r1079 = ɵngcc0.ɵɵnextContext(); return ctx_r1079.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1080); const ctx_r1081 = ɵngcc0.ɵɵnextContext(); return ctx_r1081.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1080); const ctx_r1082 = ɵngcc0.ɵɵnextContext(); return ctx_r1082.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1080); const ctx_r1083 = ɵngcc0.ɵɵnextContext(); return ctx_r1083.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1080); const ctx_r1084 = ɵngcc0.ɵɵnextContext(); return ctx_r1084.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1069 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r1069.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r1069.rangeStartLeft, ctx_r1069.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r1069.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r1069.tabindex)("aria-valuemin", ctx_r1069.min)("aria-valuenow", ctx_r1069.value ? ctx_r1069.value[0] : null)("aria-valuemax", ctx_r1069.max)("aria-labelledby", ctx_r1069.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r1087 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1087); const ctx_r1086 = ɵngcc0.ɵɵnextContext(); return ctx_r1086.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1087); const ctx_r1088 = ɵngcc0.ɵɵnextContext(); return ctx_r1088.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1087); const ctx_r1089 = ɵngcc0.ɵɵnextContext(); return ctx_r1089.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1087); const ctx_r1090 = ɵngcc0.ɵɵnextContext(); return ctx_r1090.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1087); const ctx_r1091 = ɵngcc0.ɵɵnextContext(); return ctx_r1091.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1070 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r1070.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r1070.rangeEndLeft, ctx_r1070.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r1070.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r1070.tabindex)("aria-valuemin", ctx_r1070.min)("aria-valuenow", ctx_r1070.value ? ctx_r1070.value[1] : null)("aria-valuemax", ctx_r1070.max)("aria-labelledby", ctx_r1070.ariaLabelledBy);
} }
