...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r668.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r670); const ctx_r669 = ɵngcc0.ɵɵnextContext(); return ctx_r669.menu.itemClick($event, ctx_r669.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r666.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r666.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r666.item.tabindex ? ctx_r666.item.tabindex : "0")("data-automationid", ctx_r666.item.automationId)("target", ctx_r666.item.target)("title", ctx_r666.item.title)("id", ctx_r666.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r666.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r666.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    const ctx_r671 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r671.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r673); const ctx_r672 = ɵngcc0.ɵɵnextContext(); return ctx_r672.menu.itemClick($event, ctx_r672.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r667.item.routerLink)("queryParams", ctx_r667.item.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", ctx_r667.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(12, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(13, _c1, ctx_r667.item.disabled));
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r667.item.automationId)("target", ctx_r667.item.target)("id", ctx_r667.item.id)("tabindex", ctx_r667.item.tabindex ? ctx_r667.item.tabindex : "0")("title", ctx_r667.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r667.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r667.item.label);
} }
const _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r679 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r679.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r679 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r679.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r679.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r679.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    const item_r685 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r679 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r685.visible === false || submenu_r679.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r685 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r679 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r685.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r685)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r685.visible === false || submenu_r679.visible === false))("ngStyle", item_r685.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r685 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r685.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r685.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r679 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r679.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r679.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r679.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r676.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    const item_r693 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r693.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    const item_r693 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r693.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r693)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r693.visible === false))("ngStyle", item_r693.style);
} }
...
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r677.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r699); const ctx_r698 = ɵngcc0.ɵɵnextContext(); return ctx_r698.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r699); const ctx_r700 = ɵngcc0.ɵɵnextContext(); return ctx_r700.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r674.popup))("ngStyle", ctx_r674.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r674.showTransitionOptions, ctx_r674.hideTransitionOptions)))("@.disabled", ctx_r674.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r674.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r674.hasSubMenu());
} }
