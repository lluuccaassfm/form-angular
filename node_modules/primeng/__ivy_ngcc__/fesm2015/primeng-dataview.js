...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r423.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r430); const ctx_r429 = ɵngcc0.ɵɵnextContext(); return ctx_r429.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r424 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r424.rows)("first", ctx_r424.first)("totalRecords", ctx_r424.totalRecords)("pageLinkSize", ctx_r424.pageLinks)("alwaysShow", ctx_r424.alwaysShowPaginator)("rowsPerPageOptions", ctx_r424.rowsPerPageOptions)("dropdownAppendTo", ctx_r424.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r424.paginatorDropdownScrollHeight)("templateLeft", ctx_r424.paginatorLeftTemplate)("templateRight", ctx_r424.paginatorRightTemplate)("currentPageReportTemplate", ctx_r424.currentPageReportTemplate)("showCurrentPageReport", ctx_r424.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r431 = ctx.$implicit;
    const rowIndex_r432 = ctx.index;
    const ctx_r425 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r425.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r431, rowIndex_r432));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r426.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r435); const ctx_r434 = ɵngcc0.ɵɵnextContext(); return ctx_r434.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r427 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r427.rows)("first", ctx_r427.first)("totalRecords", ctx_r427.totalRecords)("pageLinkSize", ctx_r427.pageLinks)("alwaysShow", ctx_r427.alwaysShowPaginator)("rowsPerPageOptions", ctx_r427.rowsPerPageOptions)("dropdownAppendTo", ctx_r427.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r427.paginatorDropdownScrollHeight)("templateLeft", ctx_r427.paginatorLeftTemplate)("templateRight", ctx_r427.paginatorRightTemplate)("currentPageReportTemplate", ctx_r427.currentPageReportTemplate)("showCurrentPageReport", ctx_r427.showCurrentPageReport);
} }
