...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r1472 = ctx.$implicit;
    const i_r1473 = ctx.index;
    const c_r1474 = ctx.count;
    const f_r1475 = ctx.first;
    const l_r1476 = ctx.last;
    const e_r1477 = ctx.even;
    const o_r1478 = ctx.odd;
    const ctx_r1470 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c1, ctx_r1470.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r1472 ? ctx_r1470.itemTemplate : ctx_r1470.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c2, item_r1472, i_r1473, c_r1474, f_r1475, l_r1476, e_r1477, o_r1478));
} }
