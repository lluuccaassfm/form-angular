...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r1010 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r1010.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r1010 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r1010.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r1010.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r1010 = ctx_r1020.$implicit;
    const i_r1011 = ctx_r1020.index;
    const ctx_r1015 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1015.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r1010, i_r1011));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1022); const option_r1010 = ctx.$implicit; const i_r1011 = ctx.index; const ctx_r1021 = ɵngcc0.ɵɵnextContext(); return ctx_r1021.onItemClick($event, option_r1010, i_r1011); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1022); const option_r1010 = ctx.$implicit; const i_r1011 = ctx.index; const ctx_r1023 = ɵngcc0.ɵɵnextContext(); return ctx_r1023.onItemClick($event, option_r1010, i_r1011); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1022); const ctx_r1024 = ɵngcc0.ɵɵnextContext(); return ctx_r1024.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1022); const ctx_r1025 = ɵngcc0.ɵɵnextContext(); return ctx_r1025.onBlur($event); });
    ...
    const option_r1010 = ctx.$implicit;
    const _r1012 = ɵngcc0.ɵɵreference(1);
    const _r1014 = ɵngcc0.ɵɵreference(4);
    const ctx_r1009 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r1010.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r1009.isSelected(option_r1010), ctx_r1009.disabled || option_r1010.disabled, _r1012 == ctx_r1009.focusedItem, option_r1010.icon != null, option_r1010.icon && !option_r1010.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r1009.isSelected(option_r1010))("title", option_r1010.title)("aria-label", option_r1010.label)("tabindex", ctx_r1009.tabindex)("aria-labelledby", ctx_r1009.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r1009.itemTemplate)("ngIfElse", _r1014);
} }
