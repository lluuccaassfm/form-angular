...
function PanelMenuSub_ng_template_1_li_1_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r856 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c0, !child_r856.expanded, child_r856.expanded));
} }
function PanelMenuSub_ng_template_1_li_1_a_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 14);
} if (rf & 2) {
    const child_r856 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", child_r856.icon);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r867); const child_r856 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r866 = ɵngcc0.ɵɵnextContext(); return ctx_r866.handleClick($event, child_r856); });
    ...
    const child_r856 = ɵngcc0.ɵɵnextContext(2).$implicit;
    const ctx_r859 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("href", child_r856.url || "#", ɵngcc0.ɵɵsanitizeUrl)("ngClass", ɵngcc0.ɵɵpureFunction2(10, _c1, child_r856.disabled, child_r856.expanded));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r859.item.expanded ? null : child_r856.tabindex ? child_r856.tabindex : "-1")("id", child_r856.id)("aria-expanded", child_r856.expanded)("target", child_r856.target)("title", child_r856.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(child_r856.label);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r875); const child_r856 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r874 = ɵngcc0.ɵɵnextContext(); return ctx_r874.handleClick($event, child_r856); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", child_r856.routerLink)("queryParams", child_r856.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", child_r856.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(13, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(14, _c3, child_r856.disabled));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r860.item.expanded ? null : child_r856.tabindex ? child_r856.tabindex : "-1")("id", child_r856.id)("aria-expanded", child_r856.expanded)("target", child_r856.target)("title", child_r856.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.icon);
...
function PanelMenuSub_ng_template_1_li_1_p_panelMenuSub_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("item", child_r856)("expanded", child_r856.expanded)("transitionOptions", ctx_r861.transitionOptions);
} }
function PanelMenuSub_ng_template_1_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r856 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassProp("ui-helper-hidden", child_r856.visible === false);
    ɵngcc0.ɵɵproperty("ngClass", child_r856.styleClass)("ngStyle", child_r856.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r856.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r856.items);
...
function PanelMenuSub_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r856 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", child_r856.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r856.separator);
} }
...
function PanelMenu_ng_container_1_a_3_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r881 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c8, !item_r881.expanded, item_r881.expanded));
} }
function PanelMenu_ng_container_1_a_3_span_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 12);
} if (rf & 2) {
    const item_r881 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", item_r881.icon);
} }
function PanelMenu_ng_container_1_a_3_Template(rf, ctx) { if (rf & 1) {
    const _r892 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 7);
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r892); const item_r881 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r891 = ɵngcc0.ɵɵnextContext(); return ctx_r891.handleClick($event, item_r881); });
    ...
    const item_r881 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("href", item_r881.url || "#", ɵngcc0.ɵɵsanitizeUrl);
    ɵngcc0.ɵɵattribute("tabindex", item_r881.tabindex ? item_r881.tabindex : "0")("id", item_r881.id)("target", item_r881.target)("title", item_r881.title)("aria-expanded", item_r881.expanded)("id", item_r881.id + "_header")("aria-controls", item_r881.id + "_content");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r881.label);
} }
...
function PanelMenu_ng_container_1_a_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_4_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r900); const item_r881 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r899 = ɵngcc0.ɵɵnextContext(); return ctx_r899.handleClick($event, item_r881); });
    ...
    const item_r881 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("routerLink", item_r881.routerLink)("queryParams", item_r881.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", item_r881.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(11, _c2));
    ɵngcc0.ɵɵattribute("target", item_r881.target)("title", item_r881.title)("id", item_r881.id)("tabindex", item_r881.tabindex ? item_r881.tabindex : "0");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.icon);
...
function PanelMenu_ng_container_1_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@rootItem.done", function PanelMenu_ng_container_1_div_5_Template_div_animation_rootItem_done_0_listener() { ɵngcc0.ɵɵrestoreView(_r904); const ctx_r903 = ɵngcc0.ɵɵnextContext(2); return ctx_r903.onToggleDone(); });
    ...
    ɵngcc0.ɵɵproperty("@rootItem", item_r881.expanded ? ɵngcc0.ɵɵpureFunction1(9, _c5, ɵngcc0.ɵɵpureFunction1(7, _c4, ctx_r886.animating ? ctx_r886.transitionOptions : "0ms")) : ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction1(11, _c6, ctx_r886.transitionOptions)))("ngClass", ɵngcc0.ɵɵpureFunction1(15, _c9, !item_r881.expanded || ctx_r886.animating));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("id", item_r881.id + "_content")("aria-labelledby", item_r881.id + "_header");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("item", item_r881)("expanded", true)("transitionOptions", ctx_r886.transitionOptions);
} }
...
function PanelMenu_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r881 = ctx.$implicit;
    const f_r882 = ctx.first;
    const l_r883 = ctx.last;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c10, item_r881.visible === false));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap(item_r881.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(10, _c11, f_r882, l_r883 && !item_r881.expanded, item_r881.expanded, item_r881.disabled))("ngStyle", item_r881.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r881.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r881.items);
