...
function ContextMenuSub_ng_template_1_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r299 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c0, child_r299.visible === false));
} }
...
function ContextMenuSub_ng_template_1_li_1_a_2_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r299 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", child_r299.icon);
} }
...
function ContextMenuSub_ng_template_1_li_1_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ContextMenuSub_ng_template_1_li_1_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const child_r299 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r310 = ɵngcc0.ɵɵnextContext(); return ctx_r310.itemClick($event, child_r299); });
    ...
    const _r303 = ɵngcc0.ɵɵreference(1);
    const child_r299 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r304 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMap(child_r299.styleClass);
    ɵngcc0.ɵɵproperty("href", child_r299.url || "#", ɵngcc0.ɵɵsanitizeUrl)("ngClass", ɵngcc0.ɵɵpureFunction1(14, _c1, child_r299.disabled))("ngStyle", child_r299.style);
    ɵngcc0.ɵɵattribute("target", child_r299.target)("title", child_r299.title)("id", child_r299.id)("tabindex", child_r299.tabindex ? child_r299.tabindex : "0")("aria-haspopup", _r303.items != null)("aria-expanded", _r303 === ctx_r304.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(child_r299.label);
} }
...
function ContextMenuSub_ng_template_1_li_1_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ContextMenuSub_ng_template_1_li_1_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r318); const child_r299 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r317 = ɵngcc0.ɵɵnextContext(); return ctx_r317.itemClick($event, child_r299); });
    ...
    const child_r299 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(child_r299.styleClass);
    ɵngcc0.ɵɵproperty("routerLink", child_r299.routerLink)("queryParams", child_r299.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", child_r299.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(15, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(16, _c1, child_r299.disabled))("ngStyle", child_r299.style);
    ɵngcc0.ɵɵattribute("target", child_r299.target)("title", child_r299.title)("id", child_r299.id)("tabindex", child_r299.tabindex ? child_r299.tabindex : "0");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.icon);
...
function ContextMenuSub_ng_template_1_li_1_p_contextMenuSub_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("parentActive", _r303 == ctx_r306.activeItem)("item", child_r299);
} }
...
function ContextMenuSub_ng_template_1_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function ContextMenuSub_ng_template_1_li_1_Template_li_mouseenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r323); const _r303 = ɵngcc0.ɵɵreference(1); const child_r299 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r322 = ɵngcc0.ɵɵnextContext(); return ctx_r322.onItemMouseEnter($event, _r303, child_r299); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(4, _c3, _r303 == ctx_r301.activeItem, child_r299.visible === false));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !child_r299.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r299.items);
...
function ContextMenuSub_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r299 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", child_r299.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r299.separator);
} }
...
ContextMenuSub.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ContextMenuSub, selectors: [["p-contextMenuSub"]], inputs: { parentActive: "parentActive", item: "item", root: "root" }, decls: 2, vars: 4, consts: [[1, "ui-menu-list", 3, "ngClass", "click"], ["ngFor", "", 3, "ngForOf"], ["class", "ui-menu-separator ui-widget-content", "role", "separator", 3, "ngClass", 4, "ngIf"], ["role", "none", 3, "ngClass", "mouseenter", 4, "ngIf"], ["role", "separator", 1, "ui-menu-separator", "ui-widget-content", 3, "ngClass"], ["role", "none", 3, "ngClass", "mouseenter"], ["item", ""], [3, "href", "ngClass", "ngStyle", "class", "click", 4, "ngIf"], ["role", "menuitem", 3, "routerLink", "queryParams", "routerLinkActive", "routerLinkActiveOptions", "ngClass", "ngStyle", "class", "click", 4, "ngIf"], ["class", "ui-submenu", 3, "parentActive", "item", 4, "ngIf"], [3, "href", "ngClass", "ngStyle", "click"], ["class", "ui-submenu-icon pi pi-fw pi-caret-right", 4, "ngIf"], ["class", "ui-menuitem-icon", 3, "ngClass", 4, "ngIf"], [1, "ui-menuitem-text"], [1, "ui-submenu-icon", "pi", "pi-fw", "pi-caret-right"], [1, "ui-menuitem-icon", 3, "ngClass"], ["role", "menuitem", 3, "routerLink", "queryParams", "routerLinkActive", "routerLinkActiveOptions", "ngClass", "ngStyle", "click"], [1, "ui-submenu", 3, "parentActive", "item"]], template: function ContextMenuSub_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("click", function ContextMenuSub_Template_ul_click_0_listener($event) { return ctx.listClick($event); });
